...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <div class="container-fluid">
        <div class="row min-vh-100">
            ...
            <div style="background-image: url('<?php echo e(asset('assets/banner.jpg')); ?>'); background-size: cover;" class="col-xl-6 col-lg-5 col-md-4 intro-right"></div>
            </div>
        </div>
    </div>
    </body>
</html><?php /**PATH D:\Repositories\Projects\Commission\digital-library\resources\views/landing.blade.php ENDPATH**/ ?>