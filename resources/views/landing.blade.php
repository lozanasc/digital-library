...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container-fluid">
        <div class="row min-vh-100">
            ...
            <div>
                <p> <img src="{{ asset('assets/logo.png') }}" height="128" width="128"  alt="Dumaguete City Seal Logo"></p>
                ...
                <div class="d-flex flex-row">
                    <a class="btn btn-primary my-2" href="{{ route('login') }}" role="button">Log me in</a>
            ...
            <div style="background-image: url('{{ asset('assets/banner.jpg') }}'); background-size: cover;" class="col-xl-6 col-lg-5 col-md-4 intro-right"></div>
            </div>
        </div>
    </div>
    </body>
